...
# Claude's menu in this project). The DATA stays (.dialogue/: roster, messages, COORDINAMENTO):
...
if [ -d "$PROJ/.dialogue" ]; then
  echo "  The DATA stays in $PROJ/.dialogue/ (roster, messages, COORDINAMENTO) -- detach is reversible."
