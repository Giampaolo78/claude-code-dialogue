...
echo "Your dialogue listener ('$name') is NOT running -> you would go silently deaf. Re-arm it NOW: run /dialogue-listen (or in background: dlg listen <project> coordinamento --name $name --timeout 1800), then you may stop." >&2
exit 2